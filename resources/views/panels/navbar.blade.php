  ...
  <div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav">
      <li class="nav-item">
        ...
        <h2 class="brand-text mb-0">Cleb</h2>
        </a>
      </li> 
    </ul>
  </div>
    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{route('system.users.index')}}" data-toggle="tooltip" data-placement="top" title="Analytics"><i class="ficon" data-feather="pie-chart"></i></a></li>

            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{route('system.users.index')}}" data-toggle="tooltip" data-placement="top" title="Orders"><i class="ficon" data-feather="shopping-cart"></i></a></li>
          ...
          <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
              ...
              <form method="POST" action="{{ route('system.logout') }}">
                @csrf
              <a class="dropdown-item" href="{{url('system.logout')}}"  onclick="event.preventDefault();
